...
const AddJob = () => {
  ...
  const onSubmitHandler = async(e) => {
    ...
    try {
      ...
      const  {data } = await axios.post(backendUrl+'/api/company/post-job', {title, description, salary, location,category, level}, {headers: {token: companyToken}})
