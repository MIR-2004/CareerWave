  ...
  return (
    <div className='container p-4 max-w-5xl'>
      ...
      <div className='mt-4 flex justify-end'> 
        <button onClick={() => navigate('/dashboard/add-job')} className='bg-blue-500 text-white py-2 px-4 rounded cursor-pointer'>Add New Job</button>
      </div>
    </div>
  )
}
